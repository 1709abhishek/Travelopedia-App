  ...
  useEffect(() => {
    if (accountState) {
      setUserData({
        ...
        firstName: accountState.firstName || "Unknown",
        lastName: accountState.lastName || "Unknown",
        username: accountState.username || "N/A",
        location:
        ...
        travelPercentile: 95,
        milesTraveled: 50000,
        countriesVisited: accountState.placesTravelled
          ? accountState.placesTravelled.length
          : 0,
          ...
          <div className="bg-black p-6 space-y-6">
            ...
            <Card className="bg-zinc-900 border-zinc-800">
              ...
              <CardContent>
                ...
                <Progress
                  value={userData.travelPercentile}
                  className="h-2 bg-zinc-800"
                />
                <p className="mt-2 text-center text-sm">
                  You're in the top {100 - userData.travelPercentile}% of
                  travelers!
                </p>
              </CardContent>
            </Card>
              ...
              <Card className="bg-zinc-900 border-zinc-800">
                ...
                <CardContent>
                  <div className="text-3xl font-bold">
                    {userData.milesTraveled.toLocaleString()}
                  </div>
            ...
            <Card className="bg-zinc-900 border-zinc-800">
              ...
              <CardContent>
                <TravelMap
                  placesTravelled={accountState.placesTravelled}
              ...
              <CardContent>
                <div className="space-y-4">
                  {[
                    ...
                    <div
                      key={index}
                      className="flex items-center justify-between hover:bg-zinc-800 p-2 rounded-lg cursor-pointer"
                    >
                      <div>
